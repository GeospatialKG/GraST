...
Please note:
- For vector data, compress the `.shp`, `.dbf`, and other files into a ZIP file and upload it using the Data Importer. Three sample files are provided in the Data-importer/Datasets directory: `NY_Borough.zip`, `NY_Roads.zip`, and `check-ins.zip`.<br>

- For raster data, simply upload the `.tif` file. One sample file is provided in the Data-importer/Datasets directory: `Landsat_NDVI.tif`.<br>
